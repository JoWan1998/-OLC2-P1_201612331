...
_lr_productions = [
  ...
  ('S -> ESTRUCTURAMAIN','S',1,'p_S','ascendente.py',40),
  ('S -> error','S',1,'p_S_error','ascendente.py',49),
  ('ESTRUCTURAMAIN -> main DOSPUNTOS PRECUERPO','ESTRUCTURAMAIN',3,'p_ESTRUCTURAMAIN','ascendente.py',54),
  ...
  ('ESTRUCTURAMAIN -> main DOSPUNTOS error','ESTRUCTURAMAIN',3,'p_ESTRUCTURAMAIN_ERROR3','ascendente.py',68),
  ('PRECUERPO -> PRECUERPO CUERPO','PRECUERPO',2,'p_PRECUERPO','ascendente.py',72),
  ('PRECUERPO -> CUERPO','PRECUERPO',1,'p_PRECUERPO_CUERPO','ascendente.py',78),
  ('CUERPO -> ETIQUETA','CUERPO',1,'p_CUERPO','ascendente.py',83),
  ('CUERPO -> GOTO_LABEL','CUERPO',1,'p_CUERPO','ascendente.py',84),
  ('CUERPO -> ASIGNACION','CUERPO',1,'p_CUERPO','ascendente.py',85),
  ('CUERPO -> DESTRUYE_VARIABLE','CUERPO',1,'p_CUERPO','ascendente.py',86),
  ('CUERPO -> IMPRIME','CUERPO',1,'p_CUERPO','ascendente.py',87),
  ('CUERPO -> ESTRUCTURA_IF','CUERPO',1,'p_CUERPO','ascendente.py',88),
  ('CUERPO -> EXIT','CUERPO',1,'p_CUERPO','ascendente.py',89),
  ('ETIQUETA -> ID DOSPUNTOS PRECUERPO','ETIQUETA',3,'p_ETIQUETA','ascendente.py',95),
  ('GOTO_LABEL -> goto ID PTCOMA','GOTO_LABEL',3,'p_GOTO_LABEL','ascendente.py',101),
  ('ASIGNACION -> NORMAL PTCOMA','ASIGNACION',2,'p_ASIGNACION','ascendente.py',108),
  ('ASIGNACION -> ARRAY PTCOMA','ASIGNACION',2,'p_ASIGNACION','ascendente.py',109),
  ('NORMAL -> VARIABLE IGUAL EXPRESION','NORMAL',3,'p_NORMAL','ascendente.py',114),
  ('ARRAY -> VARIABLE LISTA_POS IGUAL EXPRESION','ARRAY',4,'p_ARRAY','ascendente.py',120),
  ('EXPRESION -> VALOR','EXPRESION',1,'p_EXPRESION','ascendente.py',126),
  ('VALOR -> VARIABLE','VALOR',1,'p_VALOR_VARIABLE','ascendente.py',131),
  ('VALOR -> LLAMADA_ARREGLO','VALOR',1,'p_VALOR_LLAMADA_ARREGLO','ascendente.py',137),
  ('VALOR -> INT','VALOR',1,'p_VALOR_NUMERO','ascendente.py',142),
  ('VALOR -> FLOAT','VALOR',1,'p_VALOR_FLOAT','ascendente.py',148),
  ('VALOR -> CHAR','VALOR',1,'p_VALOR_CARACTER','ascendente.py',154),
  ('VALOR -> array PARA PARB','VALOR',3,'p_VALOR_NUEVO_ARREGLO','ascendente.py',160),
  ('VALOR -> read PARA PARB','VALOR',3,'p_VALOR_LEER','ascendente.py',167),
  ('EXPRESION -> ARITMETICAS','EXPRESION',1,'p_EXPRESION_ARITMETICAS','ascendente.py',172),
  ('ARITMETICAS -> MENOS VALOR','ARITMETICAS',2,'p_ARITMETICAS_NEGATIVO','ascendente.py',176),
  ('ARITMETICAS -> VALOR MAS VALOR','ARITMETICAS',3,'p_ARITMETICAS','ascendente.py',181),
  ('ARITMETICAS -> VALOR MENOS VALOR','ARITMETICAS',3,'p_ARITMETICAS','ascendente.py',182),
  ('ARITMETICAS -> VALOR MULTIPLICACION VALOR','ARITMETICAS',3,'p_ARITMETICAS','ascendente.py',183),
  ('ARITMETICAS -> VALOR DIVIDIR VALOR','ARITMETICAS',3,'p_ARITMETICAS','ascendente.py',184),
  ('ARITMETICAS -> VALOR RESIDUO VALOR','ARITMETICAS',3,'p_ARITMETICAS','ascendente.py',185),
  ('ARITMETICAS -> abs PARA VALOR PARB','ARITMETICAS',4,'p_ARITMETICAS_ABS','ascendente.py',200),
  ('EXPRESION -> LOGICAS','EXPRESION',1,'p_EXPRESION_LOGICAS','ascendente.py',205),
  ('LOGICAS -> NOTL VALOR','LOGICAS',2,'p_LOGICAS_NOT','ascendente.py',209),
  ('LOGICAS -> VALOR ANDL VALOR','LOGICAS',3,'p_LOGICAS','ascendente.py',214),
  ('LOGICAS -> VALOR ORL VALOR','LOGICAS',3,'p_LOGICAS','ascendente.py',215),
  ('LOGICAS -> VALOR XORL VALOR','LOGICAS',3,'p_LOGICAS','ascendente.py',216),
  ('EXPRESION -> RELACIONAL','EXPRESION',1,'p_EXPRESION_RELACIONAL','ascendente.py',227),
  ('RELACIONAL -> VALOR IGUALR VALOR','RELACIONAL',3,'p_RELACIONAL','ascendente.py',231),
  ('RELACIONAL -> VALOR NOIGUALR VALOR','RELACIONAL',3,'p_RELACIONAL','ascendente.py',232),
  ('RELACIONAL -> VALOR MAYORR IGUALR VALOR','RELACIONAL',4,'p_RELACIONAL','ascendente.py',233),
  ('RELACIONAL -> VALOR MENORR IGUALR VALOR','RELACIONAL',4,'p_RELACIONAL','ascendente.py',234),
  ('RELACIONAL -> VALOR MAYORR VALOR','RELACIONAL',3,'p_RELACIONAL','ascendente.py',235),
  ('RELACIONAL -> VALOR MENORR VALOR','RELACIONAL',3,'p_RELACIONAL','ascendente.py',236),
  ('EXPRESION -> BIT','EXPRESION',1,'p_EXPRESION_BIT','ascendente.py',253),
  ('BIT -> NOTB VALOR','BIT',2,'p_BIT_NOT','ascendente.py',257),
  ('BIT -> VALOR ANDB VALOR','BIT',3,'p_BIT','ascendente.py',262),
  ('BIT -> VALOR ORB VALOR','BIT',3,'p_BIT','ascendente.py',263),
  ('BIT -> VALOR XORB VALOR','BIT',3,'p_BIT','ascendente.py',264),
  ('BIT -> VALOR MENORR MENORR VALOR','BIT',4,'p_BIT','ascendente.py',265),
  ('BIT -> VALOR MAYORR MAYORR VALOR','BIT',4,'p_BIT','ascendente.py',266),
  ('LLAMADA_ARREGLO -> VARIABLE LISTA_POS','LLAMADA_ARREGLO',2,'p_LLAMADA_ARREGLO','ascendente.py',281),
  ('LISTA_POS -> LISTA_POS POS','LISTA_POS',2,'p_LISTA_POS_L','ascendente.py',287),
  ('LISTA_POS -> POS','LISTA_POS',1,'p_LISTA_POS_P','ascendente.py',292),
  ('POS -> CORA EXPRESION CORB','POS',3,'p_POS','ascendente.py',296),
  ('EXPRESION -> CONVERSION','EXPRESION',1,'p_EXPRESION_CONVERSION','ascendente.py',301),
  ('CONVERSION -> PARA TIPO_CONVERSION PARB VALOR','CONVERSION',4,'p_CONVERSION','ascendente.py',305),
  ('TIPO_CONVERSION -> int','TIPO_CONVERSION',1,'p_TIPO_CONVERSION','ascendente.py',311),
  ('TIPO_CONVERSION -> char','TIPO_CONVERSION',1,'p_TIPO_CONVERSION','ascendente.py',312),
  ('TIPO_CONVERSION -> float','TIPO_CONVERSION',1,'p_TIPO_CONVERSION','ascendente.py',313),
  ('EXPRESION -> PUNTERO','EXPRESION',1,'p_EXPRESION_PUNTERO','ascendente.py',318),
  ('PUNTERO -> ANDB VARIABLE','PUNTERO',2,'p_PUNTERO','ascendente.py',322),
  ('ESTRUCTURA_IF -> if PARA EXPRESION PARB goto ID PTCOMA','ESTRUCTURA_IF',7,'p_ESTRUCTURA_IF','ascendente.py',327),
  ('DESTRUYE_VARIABLE -> unset PARA VALOR PARB','DESTRUYE_VARIABLE',4,'p_DESTRUYE_VARIABLE','ascendente.py',332),
  ('IMPRIME -> print PARA VALOR PARB PTCOMA','IMPRIME',5,'p_IMPRIME','ascendente.py',337),
  ('EXIT -> exit PTCOMA','EXIT',2,'p_EXIT','ascendente.py',342),
]
